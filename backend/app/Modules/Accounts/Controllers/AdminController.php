        ...
        try {
            $clients = \App\Modules\Accounts\Models\ClientAccount::with(['users'])->get()->map(function ($client) {
                ...
                return [
                    ...
                    'phone_number' => $client->phone_number ?? ($primaryUser ? $primaryUser->phone_number : 'N/A'),
                    ...
                    'cost_per_sms' => (float) ($client->cost_per_sms ?? 1.5000),
                    'default_sender_id' => $client->default_sender_id ?? 'CASAMOKO',
                    'low_balance_threshold' => (float) ($client->low_balance_threshold ?? 100.0000),
